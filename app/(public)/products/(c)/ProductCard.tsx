...
export const ProductCard: FC<Props> = ({ product }) => {
  ...
  const handleShowPreview: MouseEventHandler<HTMLButtonElement> = (e) => {
    e.stopPropagation()
    //TODO
  }
  ...
  return (
    <div
      ...
      className='relative group border-b border-r border-t border-borderColor p-4 sm:p-6 cursor-pointer'
    >
      <div className='aspect-h-1 aspect-w-1 overflow-hidden rounded-lg'>
        {product.images.length ? (
          ...
          <NoImage width={1000} height={1000} />
        )}
        <Image
          src={
            product.images.length
      ...
      <IconButtonHover
        items={[
          ...
          },
          {
            ...
            icon: <TfiGallery size={28} />,
          },
        ]}
      />
      <div className='pb-4 pt-10 text-center'>
        <Paragraph value={product.title} />
        <Paragraph value={product.price} className='mt-4'>
          <CurrencyIcon />
        </Paragraph>
      </div>
    </div>
