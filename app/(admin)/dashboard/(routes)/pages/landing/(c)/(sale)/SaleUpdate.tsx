...
import { saleSchema, TSaleSchema } from '@/schemas'
...
export const SaleUpdate: FC<Props> = ({ data, isOpen, onClose }) => {
  ...
  const onSubmit = async (data: TSaleSchema) => {
    try {
      const response = await fetch(`/api/pages/landing/sale`, {
        method: 'PATCH',
      ...
      toast.error('Failed!')
      console.error('Failed to update sale section: ', err)
    }
  }
